...
public final class EncryptUtil {
     ...
     * @return 明文
     */
    private static byte[] decrypt3DES(byte[] data, byte[] key) {
     ...
     * @return 密文
     */
    public static String encryptAES2String(byte[] data, byte[] key) {
        return new String(encryptAES(data, key));
    }
     ...
     * @return 明文
     */
    public static String decryptAES2String(byte[] data, byte[] key) {
        return new String(decryptAES(data, key));
    }
